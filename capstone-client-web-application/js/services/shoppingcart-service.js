...
class ShoppingCartService {
    ...
    loadCartPage()
    {
        ...
        checkoutButton.classList.add("btn", "btn-success"); // green button with left margin
        checkoutButton.innerText = "Checkout";
        checkoutButton.addEventListener("click", () => this.checkoutCart());
    ...
    buildItem(item, parent)
    {
        ...
        console.log("Product ID:", item.product.productId);
            ...
            this.removeItemFromCart(item.product.productId);
        });
    ...
    removeItemFromCart(productId)
    {
        ...
        axios.delete(url)
            .then(response => {
                // Call loadCart first, and when it's done, load the page
                this.loadCart(); // reload cart data
                setTimeout(() => this.loadCartPage(), 100); // delay ensures updated data
            })
            .catch(error => {
                const data = {
